package bsu.rfe.java.group6.lab6.var12;
...
public class MainFrame extends JFrame {
    ...
    public MainFrame() {
        ...
        Action pause2Action = new AbstractAction("Приостановить движение мячей, угол скорости которых находится между 270 и 360 градусов"){
            public void actionPerformed(ActionEvent event) {
                field.pause1();
                pauseMenuItem.setEnabled(true);
